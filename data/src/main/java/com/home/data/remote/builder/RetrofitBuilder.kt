package com.home.data.remote.builder

import android.content.Context
import com.home.data.BuildConfig
import com.home.data.common.HttpClient
import com.home.data.remote.factory.RxErrorHandlingCallAdapterFactory
...
class RetrofitBuilder @Inject constructor(private val context: Context) {
    ...
    fun build(): Retrofit {
        val clientBuilder =
            okHttpClientBuilder?.let { it } ?: OkHttpClient.Builder().apply {
