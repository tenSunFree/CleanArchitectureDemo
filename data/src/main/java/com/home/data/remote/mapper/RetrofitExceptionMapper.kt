package com.home.data.remote.mapper

import android.content.Context
import com.home.data.R
import com.home.data.remote.exception.RetrofitException
import com.home.domain.exception.AlertException
import com.home.domain.exception.SnackBarException
...
class RetrofitExceptionMapper @Inject constructor(private val context: Context) {
    ...
    fun mapToCleanException(retrofitException: RetrofitException): Throwable {
        return when (retrofitException.getKind()) {
